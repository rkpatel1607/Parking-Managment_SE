...
/**
 * Servlet implementation class ViewBookingsPO
 */
@WebServlet("/ViewBookingsPO")
public class ViewBookingsPO extends HttpServlet {
		...
		try {
			...
			while (rSet.next()) {
				...
				output = output + "<td>" + rSet.getString("P_name") + "</td><td>" + rSet.getString("B_name")
						+ "</td><td>" + rSet.getString("B_regNo") + "</td><td>" + rSet.getString("B_bookingDate")
						+ "</td><td>" + rSet.getString("B_vehicleType") + "</td><td>" + rSet.getString("B_bookingtype")
						+ "</td>";
