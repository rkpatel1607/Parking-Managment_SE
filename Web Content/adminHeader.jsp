							...
							<div id="menu" class="menu-menu-1-container">
								<ul id="menu-menu-1" class="ddsmoothmenu">
									...
									<li id="menu-item-31"
										...
										href="manageUsers.jsp">Users</a>
									</li>
									<li id="menu-item-29"
										class="menu-item menu-item-type-post_type menu-item-object-page menu-item-29"><a
										href="manageVehicleDetails.jsp">Vehicles</a>
									</li>
									<li id="menu-item-31"
										class="menu-item menu-item-type-post_type menu-item-object-page menu-item-31"><a
										href="manageVehicles.jsp">Vehicle Types</a>
									</li>
									<li id="menu-item-29"
										class="menu-item menu-item-type-post_type menu-item-object-page menu-item-29"><a
										href="manageParkingSpaces.jsp">Parking Spaces</a>
									</li>
									<li id="menu-item-29"
										class="menu-item menu-item-type-post_type menu-item-object-page menu-item-29"><a
										href="approveParkingSpace.jsp">Parking Space Approval Requests</a>
									</li>
								</ul>
							</div>
						</div>
